            ...
            return (
              <div key={offer.slug} className="offer-card">
                <div className="flex items-center gap-3 mb-4">
                  <div className={`p-2.5 rounded-xl bg-primary/8 ${offer.color}`}>{offer.icon}</div>
                  <h3 className="font-heading font-bold text-foreground text-base">{cl?.name || offer.slug}</h3>
                </div>
